 ...
 * @author Digno
 */
public class FrmFiltro_insumo_mas_vendido extends javax.swing.JInternalFrame {
    ...
    DAO_itemven_insumo cidao=new DAO_itemven_insumo();
    ...
    void abrir_formulario() {
        this.setTitle("VENTAS DE INSUMO (PRECIO CON VALOR DE COMPRA)");
    ...
    void boton_cargar_filtro_imprimir(){
        cidao.imprimir_PRODUCTOS_MAS_VENDIDOS(connLocal, filtro_fecha(), idcategoria());
    }
    void actualizar_tabla_venta(){
        cidao.actualizar_tabla_filtro_venta_insumo(connLocal, tblfiltro_compra, filtro_fecha(), idcategoria());
        double suma_compra=cidao.sumar_monto_producto_mas_vendido(connLocal, filtro_fecha(), idcategoria());
        crear_grafico_mas_vendidos();
        jFsuma_compra.setValue(suma_compra);
    }
    void cargar_id_categoria() {
        idinsumo_categoria = eveconn.getInt_seleccionar_JLista(connLocal, txtidcategoria, jList_categoria, cate.getTabla(),"nombre", cate.getIdtabla());
        isCargado_idcategoria = true;
        actualizar_tabla_venta();
    }
    void crear_grafico_mas_vendidos(){
        ...
        String titulo_venta = "GRAFICO PRODUCTO INSUMO MAS VENDIDOS ("+fecdesde+" al "+fechasta+")";
        String plano_horizontal="PRODUCTO INSUMO";
        String plano_vertical="MONTO";
        evedata.createDataset_producto_mas_vendido(connLocal, dataset_prod_mas_comprado,filtro_fecha(), idcategoria());
        chard.crear_graficoBar3D(jPanel_producto_mas_comprado, dataset_prod_mas_comprado, titulo_venta, plano_horizontal, plano_vertical);
    }
    public FrmFiltro_insumo_mas_vendido() {
        initComponents();
        abrir_formulario();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SUMA DE VENDIDOS:");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("FILTRO VENTA"));
        ...
        jLabel1.setText("VENTA:TERMINADO-EMITIDO");
        ...
        jLayeredPane1.add(txtidcategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 190, -1));
        ...
        jTabbedPane1.addTab("FILTRO DE VENTA", jPanel5);
        ...
        jTabbedPane1.addTab("GRAFICO PRODUCTO MAS VENDIDOS", jPanel_producto_mas_comprado);
    ...
    private void txtidcategoriaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidcategoriaKeyReleased
        // TODO add your handling code here:
        eveconn.buscar_cargar_Jlista(connLocal, txtidcategoria, jList_categoria, cate.getTabla(),"nombre","nombre",4);
        
        if(txtidcategoria.getText().trim().length()==0){
            isCargado_idcategoria = false;
            actualizar_tabla_venta();
        }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        cidao.ancho_tabla_filtro_venta_insumo(tblfiltro_compra);
