 ...
 * @author Digno
 */
public class FrmInsumo_categoria extends javax.swing.JInternalFrame {

    EvenJFRAME evetbl = new EvenJFRAME();
    insumo_categoria unid = new insumo_categoria();
    BO_insumo_categoria uBO = new BO_insumo_categoria();
    DAO_insumo_categoria udao = new DAO_insumo_categoria();
    ...
    void abrir_formulario() {
        this.setTitle("INSUMO CAEGORIA");
        evetbl.centrar_formulario(this);        
        reestableser();
        udao.actualizar_tabla_insumo_categoria(conn, tblinsu_cate);
        color_formulario();
    }
    ...
    void boton_guardar() {
        if (validar_guardar()) {
            unid.setNombre(txtnombre.getText());
            uBO.insertar_insumo_categoria(unid, tblinsu_cate);
            reestableser();
        }
    }
    ...
    void boton_editar() {
        if (validar_guardar()) {
            unid.setIdinsumo_categoria(Integer.parseInt(txtid.getText()));
            unid.setNombre(txtnombre.getText());
            uBO.update_insumo_categoria(unid, tblinsu_cate);
        }
    }

    void seleccionar_tabla() {
        udao.cargar_insumo_categoria(unid, tblinsu_cate);
        txtid.setText(String.valueOf(unid.getIdinsumo_categoria()));
        txtnombre.setText(unid.getNombre());
    ...
    private void initComponents() {
        ...
        tblinsu_cate = new javax.swing.JTable();
        ...
        tblinsu_cate.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblinsu_cate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tblinsu_cateMouseReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tblinsu_cate);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        udao.ancho_tabla_insumo_categoria(tblinsu_cate);
    }//GEN-LAST:event_formInternalFrameOpened

    private void tblinsu_cateMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblinsu_cateMouseReleased
        // TODO add your handling code here:
        seleccionar_tabla();
    }//GEN-LAST:event_tblinsu_cateMouseReleased
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private javax.swing.JTable tblinsu_cate;
