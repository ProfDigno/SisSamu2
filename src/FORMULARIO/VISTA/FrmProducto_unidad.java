...
public class FrmProducto_unidad extends javax.swing.JInternalFrame {
    ...
    BO_producto_unidad uBO = new BO_producto_unidad();
    DAO_producto_unidad udao = new DAO_producto_unidad();
    ...
    void boton_guardar() {
        if (validar_guardar()) {
            ...
            uBO.insertar_producto_unidad(unid, tblpro_unidad);
            reestableser();
        }
    }
    ...
    void boton_editar() {
        if (validar_guardar()) {
            unid.setIdproducto_unidad(Integer.parseInt(txtid.getText()));
            unid.setNombre(txtnombre.getText());
            uBO.update_producto_unidad(unid, tblpro_unidad);
        }
    }

    void seleccionar_tabla() {
        udao.cargar_producto_unidad(unid, tblpro_unidad);
        txtid.setText(String.valueOf(unid.getIdproducto_unidad()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        udao.ancho_tabla_producto_unidad(tblpro_unidad);
