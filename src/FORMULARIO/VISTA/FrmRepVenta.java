...
public class FrmRepVenta extends javax.swing.JInternalFrame {
    ...
    void color_formulario() {
        ...
        panel_buscacliente.setBackground(clacolor.getColor_insertar_secundario());
    }
    ...
    void boton_imprimir() {
        if ((txtfecha_desde.getText().trim().length() > 0) && (txtfecha_hasta.getText().trim().length() > 0)) {
            vdao.imprimir_rep_venta_todos(conn, filtro_venta_todos());
        }
    }
    ...
    private void initComponents() {
        ...
        panel_buscacliente = new javax.swing.JPanel();
        ...
        panel_buscacliente.setBorder(javax.swing.BorderFactory.createTitledBorder("POR CLIENTE"));
        ...
        javax.swing.GroupLayout panel_buscaclienteLayout = new javax.swing.GroupLayout(panel_buscacliente);
        panel_buscacliente.setLayout(panel_buscaclienteLayout);
        panel_buscaclienteLayout.setHorizontalGroup(
            panel_buscaclienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_buscaclienteLayout.createSequentialGroup()
                .addContainerGap()
            ...
            .addGroup(panel_buscaclienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_buscaclienteLayout.createSequentialGroup()
                    .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jList_cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 408, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
        panel_buscaclienteLayout.setVerticalGroup(
            panel_buscaclienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_buscaclienteLayout.createSequentialGroup()
                .addGroup(panel_buscaclienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
        ...
        panel_principalLayout.setHorizontalGroup(
            ...
            .addComponent(panel_buscacliente, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
...
//        }
    ...
    private javax.swing.JPanel panel_buscacliente;
