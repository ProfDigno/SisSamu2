...
public class PosImprimir_Venta {
    ...
    private static void crear_archivo_texto_impresion() throws PrintException, FileNotFoundException, IOException {
        ...
        printer.printTextWrap(14 + tempfila, 14, jsprint.getSep_inicio(), totalColumna, "OBS: " + v7_observacion);
        printer.printTextWrap(15 + tempfila, 15, jsprint.getSep_inicio(), totalColumna, "VENTA:");
        printer.printTextWrap(15 + tempfila, 15, jsprint.getSep_total_gral(), totalColumna, v9_VENTA);
        printer.printTextWrap(16 + tempfila, 16, jsprint.getSep_inicio(), totalColumna, "DELIVERY:");
        printer.printTextWrap(16 + tempfila, 16, jsprint.getSep_total_gral(), totalColumna, v8_monto_delivery);
        printer.printTextWrap(17 + tempfila, 17, jsprint.getSep_inicio(), totalColumna, "TOTAL :");
        printer.printTextWrap(17 + tempfila, 17, jsprint.getSep_total_gral(), totalColumna, v6_monto);
